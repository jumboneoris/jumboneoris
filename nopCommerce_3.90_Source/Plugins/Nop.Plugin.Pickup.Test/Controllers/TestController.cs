...
namespace Nop.Plugin.Pickup.Test.Controllers
{
    [AdminAuthorize]
    public class TestController : BasePluginController
    {
        ...
        public TestController(IAddressService addressService,
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Pickup.Test/Views/Configure.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            return View("~/Plugins/Pickup.PickupInStore/Views/Create.cshtml");
        }

        [HttpPost]
        [AdminAntiForgery]
        public ActionResult Create(string btnId, string formId)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageShippingSettings))
                return Content("Access denied");
        ...
        public ActionResult Edit(int id)
        {
            ...
            return View("~/Plugins/Pickup.PickupInStore/Views/Edit.cshtml");
        }

        [HttpPost]
        [AdminAntiForgery]
        public ActionResult Edit(string btnId, string formId)
        {
            //if (!_permissionService.Authorize(StandardPermissionProvider.ManageShippingSettings))
            //    return Content("Access denied");
