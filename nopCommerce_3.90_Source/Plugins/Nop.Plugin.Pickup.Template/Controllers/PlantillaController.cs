...
using Nop.Plugin.Pickup.Plantilla.Models;
...
namespace Nop.Plugin.Pickup.Plantilla.Controllers
{
    [AdminAuthorize]
    public class PlantillaController : BasePluginController
    {
        #region Fields
        ...
        private readonly IStorePlantillaService _storePickupPointService;
        ...
        public PlantillaController(IAddressService addressService,
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Pickup.Plantilla/Views/Configure.cshtml");
        }
        ...
        public ActionResult List(DataSourceRequest command)
        {
            ...
            var model = pickupPoints.Select(x =>
            {
                ...
                return new StorePlantillaModel
                {
                    Id = x.Id,
                    Name = x.Name,
        ...
        public ActionResult Create()
        {
            ...
            var model = new StorePlantillaModel();
            ...
            return View("~/Plugins/Pickup.Plantilla/Views/Create.cshtml", model);
        }

        [HttpPost]
        [AdminAntiForgery]
        public ActionResult Create(string btnId, string formId, StorePlantillaModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageShippingSettings))
                return Content("Access denied");
            ...
            _storePickupPointService.InsertStorePlantillaRecord(pickupPoint);
        ...
        public ActionResult Edit(int id)
        {
            ...
            var pickupPoint = _storePickupPointService.GetStorePlantillaById(id);
            if (pickupPoint == null)
            ...
            return View("~/Plugins/Pickup.Plantilla/Views/Edit.cshtml", model);
        }

        [HttpPost]
        [AdminAntiForgery]
        public ActionResult Edit(string btnId, string formId, StorePlantillaModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageShippingSettings))
                return Content("Access denied");

            var pickupPoint = _storePickupPointService.GetStorePlantillaById(model.Id);
            if (pickupPoint == null)
                return RedirectToAction("Configure");
