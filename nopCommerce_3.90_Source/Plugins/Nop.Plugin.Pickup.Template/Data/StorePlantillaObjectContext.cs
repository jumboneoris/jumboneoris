...
namespace Nop.Plugin.Pickup.Plantilla.Data
{
    ...
    /// Object context
    /// </summary>
    public class StorePlantillaObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public StorePlantillaObjectContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        ...
        {
            modelBuilder.Configurations.Add(new StorePlantillaMap());
        ...
        {
            //drop the table
            this.DropPluginTable(this.GetTableName<StorePlantillaRecord>());
        }
